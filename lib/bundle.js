...
var Game = function () {
  ...
  _createClass(Game, [{
    ...
    value: function drawGame() {
      ...
      var hitbox = this.canvas.height * .75;
      ...
      this.song.notes.map(function (note) {
        ...
        if (note.y) if (note.y > hitbox + note.length) {
          note.y = 3000;
        }
        if (note.x === _this.canvas.width / 4 && note.y < hitbox + note.length && note.y > hitbox - note.length && _this.pressedRed === true && _this.pressedBow || note.x === 3 * _this.canvas.width / 8 && note.y < hitbox + note.length && note.y > hitbox - note.length && _this.pressedYellow === true && _this.pressedBow || note.x === _this.canvas.width / 2 && note.y < hitbox + note.length && note.y > hitbox - note.length && _this.pressedGreen === true && _this.pressedBow || note.x === 5 * _this.canvas.width / 8 && note.y < hitbox + note.length && note.y > hitbox - note.length && _this.pressedBlue === true && _this.pressedBow) {
          _this.score++;
          _this.resultIdx = 2;
          note.hit = true;
    ...
    value: function drawIntro(ctx) {
      ...
      ctx.textAlign = "center";
      ctx.fillStyle = "white";
      ctx.fillText("press (A/S/D/F + ENTER) to play notes!", this.canvas.width / 2, this.canvas.height / 2 - 20);
...
var canon = [['E', 2], ['A', 2], ['D', 2], ['G', 2], ['D', 2], ['G', 2], ['D', 2], ['A', 2], ['E', 2], ['A', 2], ['D', 2], ['G', 2], ['D', 2], ['G', 2], ['D', 2], ['A', 2], ['A', 0.5], ['D', 0.5], ['A', 0.5], ['D', 0.5], ['G', 0.5], ['D', 0.5], ['G', 0.5], ['D', 0.5], ['G', 0.5], ['A', 0.5], ['D', 0.5], ['G', 0.5], ['D', 0.5], ['A', 0.5], ['E', 0.5], ['G', 0.5], ['A', 0.5], ['D', 0.5], ['G', 0.5], ['A', 0.5], ['D', 0.5], ['G', 0.5], ['E', 0.5], ['A', 0.5], ['G', 0.5], ['E', 0.5], ['A', 0.5], ['D', 0.5], ['G', 0.5], ['A', 0.5], ['D', 0.5], ['G', 0.5], ['E', 0.5], ['D', 0.25], ['A', 0.25], ['E', 0.5], ['D', 0.25], ['A', 0.25], ['E', 0.25], ['G', 0.25], ['A', 0.25], ['D', 0.25], ['E', 0.25], ['G', 0.25], ['D', 0.25], ['A', 0.25], ['A', 0.5], ['G', 0.25], ['D', 0.25], ['A', 0.5], ['G', 0.25], ['D', 0.25], ['A', 0.25], ['E', 0.25], ['A', 0.25], ['D', 0.25], ['A', 0.25], ['G', 0.25], ['D', 0.25], ['A', 0.25], ['D', 0.5], ['E', 0.25], ['A', 0.25], ['D', 0.5], ['G', 0.25], ['E', 0.25], ['G', 0.25], ['E', 0.25], ['A', 0.25], ['E', 0.25], ['G', 0.25], ['D', 0.25], ['A', 0.25], ['E', 0.25], ['G', 0.5], ['A', 0.25], ['D', 0.25], ['A', 0.5], ['E', 0.25], ['G', 0.25], ['D', 0.25], ['A', 0.25], ['E', 0.25], ['G', 0.25], ['D', 0.25], ['A', 0.25], ['E', 0.25], ['G', 0.25], ['E', 2], ['A', 2], ['D', 2], ['G', 2], ['D', 2], ['G', 2], ['D', 2], ['A', 2], ['E', 2], ['A', 2], ['D', 2], ['G', 2], ['D', 2], ['G', 2], ['D', 2], ['A', 2]];
